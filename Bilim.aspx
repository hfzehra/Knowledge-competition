<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bilim.aspx.cs" Inherits="bilgiyarisma.Yarisma" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link href="Bilim.css" rel="stylesheet" />
    <title>Bilim Kulvarı</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="Anadiv">
            <div class="üst">
            <div class="ilk"><asp:Label class="sayac" ID="Lblsoru" runat="server" Text="Soru"></asp:Label></div>
